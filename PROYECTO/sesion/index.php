    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-4">
             <a href="../index.php" style="background-color: #E41919" class="btn btn-danger">Regresar a Pagina Principal</a>
              ...
              <div class="col-lg-5">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h2 class="h4 text-gray-900 mb-4">Ingreso para Vendedores y Administradores</h2>
                  </div>
